...
use App\Services\TeseSnakeCaseService;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Exception;

class TeseSnakeCaseController extends Controller
{
    /**
    ...
    public function handle_request(Request $request): JsonResponse
    {
            ...
            $process_result = TeseSnakeCaseService::process_tese_snake_case($request->all());
